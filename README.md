...
# Specific version (e.g., n8n 2.2.4 with stardawn 1.0)
docker pull stardawn/n8n-advanced:2.2.4-stardawn-1.0
...
- `:X.X.X-stardawn-X.X` - Specific n8n + stardawn version (e.g., `2.2.4-stardawn-1.0`)
